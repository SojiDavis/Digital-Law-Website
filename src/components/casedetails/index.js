                  ...
                  <div className="col-lg-12 col-md-6">
                    <div className="practice-catagory-item">
                      ...
                      <div className="practice-section">
                        <ul>
                          <li>
                            <Link to="/case-stadies-details">Family Law</Link>
                          </li>
                          <li>
                            <Link to="/case-stadies-details">Criminal Law</Link>
                          </li>
                          <li>
                            <Link to="/case-stadies-details">Business Law</Link>
                          </li>
                          <li>
                            <Link to="/case-stadies-details">
                              Personal Injury
                            </Link>
                          </li>
                          <li>
                          ...
                          <li>
                            <Link to="/case-stadies-details">Drugs Crime</Link>
                          </li>
                        </ul>
                      </div>
                    </div>
