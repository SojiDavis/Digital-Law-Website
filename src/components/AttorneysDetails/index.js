                    ...
                    <div className="col-lg-12">
                      <div className="Attorneys-info">
                        ...
                        <div className="info-outer">
                          <ul className="info">
                            <li>
                              <span>Positon: </span> Siniour Lawyer
                            </li>
                            <li>
                              <span>Practice Area: </span>Family Lawyer,
                            ...
                            <li>
                              <span>Address: </span>Nayra Park, 365 B Grand Ave,
                              Los Angeles, CA 10872
                            </li>
                            <li>
                              <span>Phone: </span>0800.123.456
                            </li>
                            <li>
                              <span>Email: </span>youremail@gmail.com
                            </li>
                            <li>
                              <span>Fax: </span>6985231456
                            </li>
                          </ul>
                          <ul className="social">
                            <li>
            ...
            <div className="col-lg-8">
              ...
              <div className="education-section">
                ...
                <span>
                  ...
                  Admization Institute of Law andTechnology, Juzment School of
                ...
                <span>
                  <i className="fa fa-caret-right" aria-hidden="true"></i>The
                  Syntify High School Of New York
                </span>
                <span>
                  <i className="fa fa-caret-right" aria-hidden="true"></i>
